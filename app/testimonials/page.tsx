...
const SOCIETY_VOICES = [
  {
    quote: "The strategic thinking demanded by British Parliamentary debating is identical to top-tier management consulting. Competing globally with UNDS was the hardest and most rewarding thing I did at university.",
    author: "Amara Nwosu",
    role: "Strategy Analyst, McKinsey & Co.",
    context: "Pan-African Universities Debating Championship Finalist",
  },
  {
    quote: "Adjudicating for the Spartans means holding some of the sharpest minds in the country to international forensic standards. The caliber of analytical clarity generated here is world-class.",
  ...
  {
    quote: "As a freshman, walking into the UNDS chambers was intimidating. But the mentorship structure here is deliberate. They don't just critique your style; they break down your logic and rebuild you into a master advocate.",
    author: "Tobi Adebayo",
    ...
    <main className="relative min-h-screen bg-background overflow-hidden text-text-primary selection:bg-primary/20">
      ...
      <section className="relative pt-24 pb-16 border-b border-border/60 mx-auto max-w-7xl px-6 sm:px-8 z-10">
        <p className="mt-6 max-w-2xl font-garamond text-xl sm:text-2xl italic leading-relaxed text-text-secondary">
          From international grand finals to corporate boardrooms—our alumni and members reflect on the transformational power of forensic discourse.
        </p>
      </section>
      ...
      <section className="relative py-16 lg:py-24 border-b border-border/60 mx-auto max-w-7xl px-6 sm:px-8 z-10">
        <div className="grid grid-cols-1 gap-12 items-center lg:grid-cols-12 lg:gap-16">
          ...
          <div className="lg:col-span-7 flex flex-col justify-center">
            <span className="text-4xl font-serif text-primary/40 leading-none h-3 pointer-events-none">“</span>
            <blockquote className="m-0 font-garamond text-2xl sm:text-2xl  leading-relaxed text-text-primary">
              {FEATURED_TESTIMONIAL.quote}
            </blockquote>
            <span className="text-4xl font-serif text-primary/40 leading-none h-3 text-right block pointer-events-none -translate-y-4">”</span>
      ...
      {/* --- PAGE FOOTER TIMELINE BOUNDARY --- */}
      <footer className="relative max-w-7xl mx-auto px-6 sm:px-8 z-10 pb-16">
        <div className="pt-6 border-t border-border/40 flex flex-col sm:flex-row justify-between gap-2 text-[10px] font-ui font-bold tracking-[0.2em] text-text-muted ">
          <span>UNDS Records Chamber</span>
          <span>The Spartans Unbound • Verified Chronicle</span>
        </div>
      </footer>
    </main>
  );
