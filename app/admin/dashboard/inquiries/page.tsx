    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        {messages.map((message) => (
          <div key={message.id} className="border border-[#2e3a28]/10 bg-white p-5 rounded-xs space-y-2">
            <div className="flex items-center justify-between gap-4">
              ...
              <form action={resolveContactAction.bind(null, message.id)}>
                <button type="submit" className="text-xs font-ui tracking-wider text-[#2e3a28] font-bold cursor-pointer shrink-0">
                  Archive / Resolve
                </button>
              </form>
            </div>
