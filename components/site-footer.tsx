...
export default function SiteFooter() {
  return (
    <footer className="border-t border-primary/10 bg-[rgba(247,245,250,0.7)] backdrop-blur-sm">
      <div className="mx-auto grid max-w-7xl gap-12 px-4 py-14 sm:px-6 justify-evenly lg:grid-cols-[2fr_0.7fr_1fr] lg:px-8">
        <div className="space-y-5">
          <div className="space-y-2">
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              />
              <p className="min-w-0 whitespace-nowrap font-heading text-2xl font-semibold leading-none text-primary-dark">
            ...
            <Button className="font-garamond">
              Join Today
            </Button>              
            </div>
        ...
        <div>
          <p className="font-garamond text-xs font-semibold uppercase tracking-[0.28em] text-text-muted">
            Navigate
          </p>
          ...
          <div className="mt-4 grid gap-4 text-sm text-text-body">
            <div className="grid gap-2">
              ...
              <span className="inline-flex items-start justify-start gap-2">
                ...
                <span>Fifth Year Classroom, Pharmacy Complex, University of Nigeria, Nsukka Campus</span>
              </span>
                <span className="inline-flex items-start justify-start gap-2">
      ...
      <div className="border-t border-primary/10">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-4 text-sm text-text-muted sm:flex-row sm:items-center sm:justify-end sm:px-6 lg:px-8">
          <p>© 2026 UNDS Technical Team & the Chameleony Dev.</p>
        </div>
      </div>
    </footer>
  );
